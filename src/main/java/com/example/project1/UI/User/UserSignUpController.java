...
public class UserSignUpController implements RequiresSharedData {

    private PawCare pawCare; // Shared instance injected via setSharedData
    private LoginClassCredentials loginCredentials; // Shared instance injected via setSharedData
    ...
    private boolean handleSignUp() {
        // Use the shared pawCare instance
    ...
    private void saveLoginCredentials() {
        ...
        if (loginCredentials != null) {
            ...
            loginCredentials.setType("user"); // Set user type as "user"
        } else {
            showAlert("Error", "Login credentials object not initialized.");
        }
    }
